...
•	Iterate over the review_dates, using date as your iterator variable.
	o	Calculate the date 30 days back by subtracting glanceback from date.
	o	Print the date, along with 'day_type' and 'total_ridership'from daily_summaries for that date.
	o	Print the prior_period_dt, along with 'day_type' and 'total_ridership' from daily_summaries for that date (prior_period_dt).
