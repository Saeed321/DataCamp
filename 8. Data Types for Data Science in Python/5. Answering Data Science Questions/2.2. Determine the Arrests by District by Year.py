•	Loop over the crimes_by_district dictionary, unpacking it into the variables district and crimes.
	o	Create an empty Counter object called year_count.
	o	Loop over the crimes:
	...
	o	Print the Counter. This has been done for you, so hit 'Submit Answer' to see the result!
