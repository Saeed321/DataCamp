...
# Convolutional networks for classification are constructed from 
# a sequence of convolutional layers (for image processing) and fully connected (Dense) layers (for readout). 
