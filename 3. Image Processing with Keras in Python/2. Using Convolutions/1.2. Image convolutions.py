...
# Given a black and white image that is stored in the variable im, write the operations inside the loop 
# that would execute the convolution with the provided kernel.
