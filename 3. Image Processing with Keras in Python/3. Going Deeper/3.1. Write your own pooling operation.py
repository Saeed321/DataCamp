...
# and reduce the number of parameters in the next layer in the network. 
# This can help us if we want to train the network more rapidly, 
...
# In this exercise, you will write your own max pooling operation, 
# based on the code that you previously used to write a two-dimensional convolution operation.
