...
# However, you will also add a pooling layer. The architecture will add a single max-pooling layer 
# between the convolutional layer and the dense layer with a pooling of 2x2:
# Convolution => Max pooling => Convolution => Flatten => Dense

# A Sequential model along with Dense, Conv2D, Flatten, and MaxPool2D objects are available in your workspace.
# •	Add an input convolutional layer (15 units, kernel size of 2, reluactivation).
