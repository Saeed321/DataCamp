...
# Training a deep learning model is very similar to training a single layer network. 
# Once the model is constructed (as you have done in the previous exercise), the model needs to be compiled with the right set of parameters. 
