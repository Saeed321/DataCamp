...
# In a color image, you can change the values in one of the color channels 
# without affecting the other colors, by indexing on the last dimension of the array.
