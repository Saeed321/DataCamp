...
# Deep learning models can take a long time to train, 
# especially when you move to deeper architectures and bigger datasets. 
# Saving your model every time it improves as well as stopping it when it 
# no longer does allows you to worry less about choosing the number of epochs to train for. You can also restore a saved model anytime.
