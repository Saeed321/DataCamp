...
# They contain the names of the competitors as strings. 
# You will first turn these competitors into unique numbers,then use the to_categorical() function from keras.utils 
# to turn these numbers into their one-hot encoded representation.
# This is useful for multi-class classification problems, 
# since there are as many output neurons as classes and for every observation in 
# our dataset we just want one of the neurons to be activated.
...
# •	Apply to_categorical() to your labels, that is the competitorcolumn.
