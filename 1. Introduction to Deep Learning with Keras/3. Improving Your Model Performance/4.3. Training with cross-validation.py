...
# The create_model() function has been redefined so that it now creates a model with those parameters. 
# X and y are loaded for you to use as features and labels.
# In this exercise you do pass the best epochs and batchsize values found for your model to the KerasClassifier object 
# so that they are used when performing crossvalidation.
