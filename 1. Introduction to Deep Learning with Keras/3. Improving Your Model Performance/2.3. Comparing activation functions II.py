...
# The code used in the previous exercise has been executed to obtain theactivation_results 
# with the difference that 100 epochs instead of 20 are used. 
# That way you'll have more epochs to further compare how the training evolves per activation function.
