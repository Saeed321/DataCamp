...
# You could try random_search.fit(X,y) in the console yourself to check it does work after you have built everything else, 
# but you will probably timeout your exercise (so copy your code first if you try it!).
# You don't need to use the optional epochs and batch_size parameters when building your KerasClassifier 
# since you are passing them as params to the random search and this works as well.
