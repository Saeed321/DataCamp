...
# Let's see how two identical models with and without batch normalization compare.
# The model you just built batchnorm_model is loaded for you to use. 
# An exact copy of it without batch normalization: standard_model, is available as well. 
# You can check their summary() in the console. X_train, y_train, X_test, and y_test are also loaded so that you can train both models.
