...
# Building a CNN model in Keras isn't much more difficult than building any of the models you've already built throughout the course! 
# You just need to make use of convolutional layers.
# You're going to build a shallow convolutional model that classifies the MNIST dataset of digits. 
# The same one you de-noised with your autoencoder!. 
# The images are 28x28 pixels and just have one channel.
