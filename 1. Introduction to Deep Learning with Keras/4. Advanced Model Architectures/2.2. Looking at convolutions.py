...
# You have to do it at least once in your lifetime!
# To do so, you will build a new model with the Keras Model object, 
# which takes in a list of inputs and a list of outputs. 
# The output you will provide to this new model is the first convolutional layer outputs when given an MNIST digit as input image.
...
# •	Plot the activations of the first digit of X_test for the 15th and the 18thneuron filter.
