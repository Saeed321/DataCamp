...
# 'adam' is a good default optimizer to use, and will generally work well. Loss function depends on the problem at hand. 
...
# For this dataset, 'mean_absolute_error' works pretty well, so use it as your loss function.
