...
# It also has the seed difference between the teams 
# (seeds are assigned by the tournament committee and represent a ranking of how strong the teams are) 
# and the score difference of the game (e.g. if team_1 wins by 5 points, the score difference is 5).
