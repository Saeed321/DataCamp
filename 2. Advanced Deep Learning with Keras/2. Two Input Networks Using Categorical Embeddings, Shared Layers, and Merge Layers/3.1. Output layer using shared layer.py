...
# Now that you've looked up how "strong" each team is, subtract the team 
# strengths to determine which team is expected to win the game.
...
# you'll use the difference of your own team strength model to predict score differences.
