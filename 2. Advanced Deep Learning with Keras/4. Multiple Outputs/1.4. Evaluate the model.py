...
# Now that you've fit your model and inspected it's weights to make sure it makes sense, 
# evaluate it on the tournament test set to see how well it performs on new data.
