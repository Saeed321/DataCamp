...
# Now you will create a different kind of 2-output model. 
# This time, you will predict the score difference, instead of both team's scores and 
# then you will predict the probability that team 1 won the game. 
...
# Your inputs (seed difference and predicted score difference) have a mean of very close to zero, 
# and your outputs both have means that are close to zero, so your model shouldn't need the bias term to fit the data well.
