...
# o	Permute the bd_parent_scandens array using np.random.permutation().
# o	Compute the heritability between the permuted array and the bd_offspring_scandens array using the heritability() function you wrote in the last exercise. Store the result in the replicates array.
