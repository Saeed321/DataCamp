...
# o	Use np.arange() to set up an array of indices going from 0 to len(x). These are what you will resample and use them to pick values out of the x and y arrays.
# o	Use np.empty() to initialize the slope and intercept replicate arrays to be of size size.
...
# o	Return the pair bootstrap replicates of the slope and intercept.
