...
# Your task here is to prepare a DataFrame hosts by left joining editionsand ioc_codes.
...
# o	Extract the columns 'Edition' and 'NOC'.
# o	Set 'Edition' column as the Index.
