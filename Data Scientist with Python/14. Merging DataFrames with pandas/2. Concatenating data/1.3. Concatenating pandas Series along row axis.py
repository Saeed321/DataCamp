...
# o	In each iteration of the loop, append the 'Units' column of each DataFrame to units.
# •	Concatenate the Series contained in the list units into a longer Series called quarter1 using pd.concat().
# o	Specify the keyword argument axis='rows' to stack the Series vertically.
