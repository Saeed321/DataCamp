...
# o	Use the keyword argument keys=['bronze', 'silver', 'gold'] to yield suitable hierarchical indexing.
# o	Use axis=1 to get horizontal concatenation.
# o	Use join='inner' to keep only rows that share common index labels.
