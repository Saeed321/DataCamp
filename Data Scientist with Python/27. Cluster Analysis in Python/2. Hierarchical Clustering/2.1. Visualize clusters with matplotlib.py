...
# •	Plot a scatter plot with colors for each cluster as defined by the colorsdictionary.

# •	Use integers as keys for the dictionary, colors.
# •	Use column names for x and y arguments in the .scatter()method.
# •	Use a lambda function to print the corresponding value of the colorsdictionary, given a cluster is the key.
