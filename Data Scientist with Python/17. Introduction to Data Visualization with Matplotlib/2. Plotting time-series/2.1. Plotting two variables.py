...
# To create a twin Axes object that shares the x-axis, we use the twinxmethod.
...
# •	Plot the relative temperature variable in the twin Axes using its plotmethod.
