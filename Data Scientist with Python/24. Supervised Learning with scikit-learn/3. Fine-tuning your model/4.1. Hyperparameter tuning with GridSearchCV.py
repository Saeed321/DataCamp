...
# o	Inside GridSearchCV(), specify the classifier, parameter grid, and number of folds to use.
# o	Use the .fit() method on the GridSearchCV object to fit it to the data X and y.
