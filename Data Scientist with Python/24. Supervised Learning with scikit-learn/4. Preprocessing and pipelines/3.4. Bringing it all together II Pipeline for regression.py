...
# o	'imputation', which uses the Imputer() transformer and the 'mean' strategy to impute missing data ('NaN') using the mean of the column.
# o	'scaler', which scales the features using StandardScaler().
# o	'elasticnet', which instantiates an ElasticNet() regressor.
