...
# o	get_numeric_data, with the name 'selector'.
# o	Imputer(), with the name 'imputer'.
# •	Complete the 'text_features' transform with the following steps:
# o	get_text_data, with the name 'selector'.
# o	CountVectorizer(), with the name 'vectorizer'.
