...
# o	In the first for loop, iterate over nodes_of_interest and append the current node n to nodes_to_draw.
# o	In the second for loop, iterate over the neighbors of n, and append all the neighbors nbr to nodes_to_draw.
