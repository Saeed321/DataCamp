...
# •	Write a function nodes_in_triangle() that has two parameters - Gand n - and identifies all nodes in a triangle relationship with a given node.
# o	In the for loop, iterate over all possible triangle relationship combinations.
# o	Check whether the nodes n1 and n2 have an edge between them. If they do, add both nodes to the set triangle_nodes.
