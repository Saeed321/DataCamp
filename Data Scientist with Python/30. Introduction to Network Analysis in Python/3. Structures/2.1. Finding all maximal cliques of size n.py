...
# o	In the for loop, iterate over all the cliques in G using the nx.find_cliques() function.
# o	If the current clique is of size size, append it to the list mcs.
