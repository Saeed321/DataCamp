...
# •	Set the 'weight' attribute of the edge between node 1 and 10 of Tto be equal to 2. Refer to the following template to set an attribute of an edge: network_name.edges[node1, node2]['attribute'] = value. Here, the 'attribute' is 'weight'.
# •	Set the weight of every edge involving node 293 to be equal to 1.1. To do this:
# o	Using a for loop, iterate over all the edges of T, including the metadata.
# o	If 293 is involved in the list of nodes [u, v]:
