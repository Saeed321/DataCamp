...
# o	Compute the degree centrality of G.
# o	Compute the maximum degree centrality using the max() function onlist(deg_cent.values()).
# o	Iterate over the degree centrality dictionary, deg_cent.items().
# o	If the degree centrality value v of the current node k is equal to max_dc, add it to the set of nodes.
