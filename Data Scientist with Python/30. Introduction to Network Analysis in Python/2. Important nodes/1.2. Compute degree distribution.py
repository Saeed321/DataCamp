...
# o	Use n as your iterator variable.
# o	The output expression of your list comprehension should be the number of neighbors that node n has - that is, its degree. Use the len() and list() functions together with the .neighbors() method to compute this.
# o	The iterable in your list comprehension is all the nodes in T, accessed using the .nodes() method.
