...
# o	Compute the betweenness centrality of G.
# o	Compute the maximum betweenness centrality using the max()function on list(bet_cent.values()).
# o	Iterate over the degree centrality dictionary, bet_cent.items().
# o	If the degree centrality value v of the current node k is equal to max_bc, add it to the set of nodes.
