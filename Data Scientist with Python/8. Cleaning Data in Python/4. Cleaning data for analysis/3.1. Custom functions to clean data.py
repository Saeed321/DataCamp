...
# As Dan showed you in the videos, you can use the .apply() method to applya function across entire rows or columns of DataFrames. However, note that each column of a DataFrame is a pandas Series. Functions can also be applied across Series. Here, you will apply your function over the 'sex' column.

# Instructions

# •	Define a function named recode_gender() that has one parameter: gender.
# o	If gender equals 'Female', return 0.
# o	Else, if gender equals 'Male', return 1.
# o	If gender does not equal 'Male' or 'Female', return np.nan. NumPy has been pre-imported for you.
