...
# o	Use \d{x} to match x digits. Here you'll need to use it three times: twice to match 3 digits, and once to match 4 digits.
# o	Place the regular expression inside re.compile().
