...
# o	Note that because you're applying it over the entire DataFrame, and not just one column, you'll have to chain the .all() method twice.
# o	Remember that you don't have to use () for functions placed inside .apply().
