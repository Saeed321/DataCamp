...
# o	Use input_shape to specify the input shape in the first hidden layer.
# o	Use 'relu' activation for the 3 hidden layers and 'softmax' for the output layer, which should have 2 units.
