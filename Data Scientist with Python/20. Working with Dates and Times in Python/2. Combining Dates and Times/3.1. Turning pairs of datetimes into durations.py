...
# o	Use arithmetic on the start and end elements to find the length of the trip
# o	Save the results to trip_duration.
# o	Calculate trip_length_seconds from trip_duration.
